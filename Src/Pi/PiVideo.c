...
// DEPRECATED: #include <bcm_host.h>
// DEPRECATED: include <interface/vchiq_arm/vchiq_if.h>
#include <EGL/egl.h>
#include <GLES2/gl2.h>
#include <SDL.h>
...
int piInitVideo()
{
	...
	/* DEPRECATED: DISPMANX is not supported on VideoCoreVI
