...
int msxBusWrite(MbHandle* mbHandle, UInt16 address, UInt8 value);

int msxBusReadIo(MbHandle* mbHandle, UInt16 port);
int msxBusWriteIo(MbHandle* mbHandle, UInt16 port, UInt8 value);
